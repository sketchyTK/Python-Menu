    ...
    while True:
        ...
        # TODO: Extract the food category and the options for each category
            ...
            # TODO: Extract the meal and the price for each option
                ...
                food_category = item_name_parts[0]  # This will be 'Burrito'
                meal = item_name_parts[1]       # This will be 'Chicken'
        ...
        input(f"Input the Menu Item Number?")
        ...
        input(f"Would you like to order anything else?\n"
              f"Type 'n' or 'N' to quit")        
